% - Este programa traza curvas de velocidad angular en función del tiempo
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
figure(hRPM);
xlabel('t (segundos)')
title('Respuesta del motor a una entrada cuadrada');
ylabel('VelAng (rad/s)')
%%%%%%%%%%%%%%%%%%%
% 0: Medidas
%%%%%%%%%%%%%%%%%%%
...
legend show;% general, alternativa que necesita 'DisplayName'; debe comentarse si se utiliza legend('-DynamicLegend');
	...
	%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%
% 3: bajada de la señal cuadrada con pB_j
%%%%%%%%%%%%%%%%%%%
for i=1:TensionVectorL
...
%%%%%%%%%%%%%%%%%%%%
%% 4: bajada de la señal cuadrada con  KM,pM 
%%%%%%%%%%%%%%%%%%%
for i=1:TensionVectorL
	sys=tf([KM*VeqV(i)],[1 pM]);
	[escalon,Paramt]=step(sys,DuracionSubida);
