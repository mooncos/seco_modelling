% - Este programa permite trazar cinco curvas:  de varianza y polo en función del intervalo de tiempo; de velocidad angular en función del tiempo y de los polinomios de interpolación Veq-V y V-Veq.
...
z1=0.5;% ponderación de los polos de subida y bajada SIN MODIFICAR
opCurvas=[1 1 1]; %SIN MODIFICAR
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
PrefNomMeanA='./data/secoData_';
PrefNomMeanB='.mean';
PrefNomFicheroEscritura='./processed/MotorDCPololu';
...
for i=1:TensionVectorL
	...
	NomFicheroLecturaMean{i}=strcat(PrefNomMeanA,NTension,'V',PrefNomMeanB);
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% error cuadrático, pM, KM, VeqV, PSB, KSB
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
a2=0;
a3=0;
a4=0;
...
for i=1:TensionVectorL
	...
	PSB=[PSB poloMedia];% vector de polos p_j asociado al intervalo de varianza mínima
end
...
for i=1:TensionVectorL
	...
	KSB1=Gzero*PSB(i);
	KSB=[KSB KSB1];% vector de K_j asociado al intervalo de varianza mínima
end
J=errorVeq2/2;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Polinomios de interpolación: a, b, TensionVectorP, VeqVP
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
