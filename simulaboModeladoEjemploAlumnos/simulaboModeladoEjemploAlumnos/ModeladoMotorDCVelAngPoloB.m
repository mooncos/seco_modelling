% - Programa que permite calcular la velocidad angular media a partir de un fichero de datos. Calcula también los polos de subida y bajada estimados de una señal cuadrada. Todos estos datos se guardan en un fichero Resumen.
% - Se utilizará en un bucle de longitud el número de valores de tensión del escalón de entrada al motor
% - Requiere introducir manualmente los parámetros:
%		IniS		índice inicial subida
%		InfS		índice final subida
%		InfB		índice subida + bajada
%		kTs		índice frontera régimen permanente subida (para el cálculo de la velocidad angular media)
%		DeltatS		Deltat de subida (ver algoritmo de creación de intervalos en la función interna  PoloVarianzaMinEscalon) 
%		DnS		Dn de subida (ver algoritmo de creación de intervalos en la función interna PoloVarianzaMinEscalon)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% ENTRADAS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 	indTension:			índice del vector de tensiones, necesario para el fichero Resumen
%	Tension:			tensión de entrada al motor  en voltios: escalón de subida
%	CPR:				pulsos/vuelta
...
% 	- fichero RESUMEN. Hay un único fichero Resumen para el conjunto de valores de tensión. Cuando indTension=1 se crea un nuevo fichero Resumen, y cuando indTension>1 se adjuntan nuevas filas. Cada fila se corresponde con una Tension, cuyo formato es el siguiente:
%		poloMediaS*1e+20		: polo medio de varianza mínima transitorio de subida
...
%	- fichero POLO. Se crea un fichero por cada Tension. Es un fichero de texto de dos columnas de longitud el número de intervalos de tiempo: la primera es la varianza y la segunda el polo para cada intervalo, multiplicados por 1e+20.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
DnS=2;%>=2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% VelAngMedia SUBIDA: régimen permanente
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Polo medio a mínima desviación típica de la secuencia de polos medios de cada intervalo
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
